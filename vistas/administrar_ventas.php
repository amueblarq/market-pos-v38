...
<head>
    ...
    <!-- Agregar cualquier estilo necesario -->
    <style>
        body {
...
form[action="pedidos_materiales.php"] input[type="submit"] {
    /* Estilos existentes que ya has definido */
    background-color: #4CAF50;
    color: white;
    border: none;
    padding: 10px 20px;
    ...
    cursor: pointer;
    border-radius: 5px;
    margin-right: 13px; /* Espacio a la derecha para separar del otro botón */
}
...
<body>
    ...
    <div class="content pb-2">
        ...
        $conexion = new mysqli("l217.15.171.64", "Amueblarq1", "Amueblarq.270", "sistema_poss");
